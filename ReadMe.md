```
git submodule add https://github.com/EloiStree/2026_08_09_gdp_text_interpeter_sc_cmd.git addons/2026_08_09_gdp_text_interpeter_sc_cmd
```
```
git clone https://github.com/EloiStree/2026_08_09_gdp_text_interpeter_sc_cmd.git addons/2026_08_09_gdp_text_interpeter_sc_cmd
```
...
`[[past:text]]` The text between is to put in the clipboard
`sc: 1000> [[cmd:text]]` The following is an command line in a shortcut text
